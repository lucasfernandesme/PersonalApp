            ...
            <div className="grid grid-cols-2 gap-4">
                {fields.map(field => (
                    <div key={field}>
                        ...
                        <input
                            type="number"
                            className="w-full p-3 rounded-xl bg-zinc-50 border-none font-bold text-zinc-900"
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-300 pb-20">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h2 className="text-2xl font-black text-zinc-900 dark:text-white">Avaliações</h2>
                    <p className="text-zinc-500 text-sm font-medium">Gerencie avaliações e anamneses</p>
                </div>
            </div>
                ...
                <div className="bg-white dark:bg-zinc-900 rounded-[32px] border border-zinc-100 dark:border-zinc-800 overflow-hidden transition-all duration-300">
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-lg font-black text-zinc-900 dark:text-white leading-tight">Morfológica</h3>
                            ...
                            <div className="space-y-3 pl-4 border-l-2 border-zinc-100 dark:border-zinc-800 ml-6">
                                {(student.assessments || []).map((assessment, index) => (
                                    <div key={assessment.id || index} className="pl-6 relative group">
                                        ...
                                        >
                                            <div>
                                                <p className="font-bold text-zinc-900 dark:text-white text-sm">{assessment.date}</p>
                                            ...
                                            <div className="flex items-center gap-4">
                                                <div className="text-right">
                                                    <p className="font-black text-zinc-900 dark:text-white text-lg">{assessment.weight}kg</p>
                                    ...
                                    <div key={anam.id || index} className="pl-6 relative group">
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-4">
                                                <h4 className="font-bold text-zinc-900 dark:text-white text-sm">{anam.date}</h4>
                ...
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-zinc-900 w-full max-w-lg rounded-[32px] p-6 max-h-[90vh] overflow-y-auto custom-scrollbar">
                        <div className="flex items-center justify-between mb-6">
                            <h3 className="text-xl font-black text-zinc-900 dark:text-white">{editingAssessmentId ? 'Editar Avaliação' : 'Nova Avaliação'}</h3>
                            <button onClick={() => {
                                setShowNewAssessmentModal(false);
                                setEditingAssessmentId(null);
            ...
            {showNewAnamnesisModal && (
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-zinc-900 w-full max-w-2xl rounded-[32px] p-6 max-h-[90vh] overflow-y-auto custom-scrollbar flex flex-col">
                        <div className="flex items-center justify-between mb-6">
                            <h3 className="text-xl font-black text-zinc-900 dark:text-white">Nova Anamnese Completa</h3>
                        ...
                        <div className="space-y-4 flex-1 overflow-y-auto px-1">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-3 rounded-xl bg-zinc-50 dark:bg-zinc-950 border-none font-bold text-zinc-900 dark:text-white"
                                />
                            </div>
                                ...
                                <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full p-3 rounded-xl bg-zinc-50 dark:bg-zinc-950 border-none font-medium text-zinc-900 dark:text-white min-h-[80px]"
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                className="w-full p-3 rounded-xl bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/20 font-medium text-zinc-900 dark:text-white"
            ...
            {selectedAnamnesis && (
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-zinc-900 w-full max-w-2xl rounded-[32px] p-6 max-h-[90vh] overflow-y-auto custom-scrollbar">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                <h3 className="text-xl font-black text-zinc-900 dark:text-white">Detalhes da Anamnese</h3>
            ...
            {selectedAssessment && (
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-zinc-900 w-full max-w-lg rounded-[32px] p-6 max-h-[90vh] overflow-y-auto custom-scrollbar">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                <h3 className="text-xl font-black text-zinc-900 dark:text-white">Detalhes da Avaliação</h3>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4 bg-zinc-50 dark:bg-zinc-950 p-4 rounded-2xl">
                                <div>
                                    ...
                                    <p className="font-black text-zinc-900 dark:text-white text-lg">{selectedAssessment.weight}kg</p>
                                </div>
                                {selectedAssessment.height && (
                                    <div>
                                        <p className="text-[10px] font-bold text-zinc-400 uppercase">Estatura</p>
                                        <p className="font-black text-zinc-900 dark:text-white text-lg">{selectedAssessment.height}m</p>
                                    </div>
                                )}
                                <div>
                                    <p className="text-[10px] font-bold text-zinc-400 uppercase">Protocolo</p>
                                    <p className="font-bold text-zinc-900 dark:text-white">{selectedAssessment.protocol}</p>
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {Object.entries(selectedAssessment.skinfolds).map(([key, value]) => (
                                        <div key={key} className="bg-zinc-50 dark:bg-zinc-950 p-3 rounded-xl flex justify-between items-center">
                                            ...
                                            <span className="font-black text-zinc-900 dark:text-white">{value}mm</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {Object.entries(selectedAssessment.circumferences).map(([key, value]) => (
                                            <div key={key} className="bg-zinc-50 dark:bg-zinc-950 p-3 rounded-xl flex justify-between items-center">
                                                ...
                                                <span className="font-black text-zinc-900 dark:text-white">{value}cm</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                            ...
                            {selectedAssessment.notes && (
                                <div>
                                    <h4 className="font-black text-zinc-900 dark:text-white mb-2 text-sm">Observações</h4>
                            ...
                            <div className="border-t-2 border-dashed border-zinc-200 dark:border-zinc-800 pt-6 mt-2">
                                <h4 className="font-black text-zinc-900 dark:text-white mb-4 flex items-center gap-2 text-lg">
                                        ...
                                        <>
                                            <div className="grid grid-cols-2 gap-3 mb-6">
                                                <div className="bg-zinc-50 dark:bg-zinc-950 p-3 rounded-xl">
                                                    ...
                                                    <p className="font-black text-zinc-900 dark:text-white">{calculateIMC(selectedAssessment.weight, selectedAssessment.height || 0)}</p>
                                                </div>
                                                <div className="bg-zinc-50 dark:bg-zinc-950 p-3 rounded-xl">
                                                ...
                                                <div className="bg-zinc-50 dark:bg-zinc-950 p-3 rounded-xl">
                                                    ...
                                                    <p className="font-black text-zinc-900 dark:text-white">{sumSkinfolds(selectedAssessment.skinfolds).toFixed(1)} mm</p>
                                                </div>
                                                        ...
                                                        <div className="flex justify-center gap-8 mb-4 text-xs font-bold">
                                                            <div className="flex items-center gap-1">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-zinc-900 dark:text-white text-sm">{(100 - displayBodyFat).toFixed(1)}%</p>
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center gap-1">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-zinc-900 dark:text-white text-sm">{displayBodyFat.toFixed(1)}%</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="flex flex-col items-center w-full">
                                                        ...
                                                        <div className="flex justify-center gap-8 mb-4 text-xs font-bold w-full max-w-xs">
                                                            <div className="flex items-center gap-1">
                                                                ...
                                                                <div>
                                                                    <p className="text-emerald-500">Massa Magra</p>
                                                                    <p className="text-zinc-900 dark:text-white text-sm">{displayLeanMass} kg</p>
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center gap-1">
                                                                <div className="w-2 h-8 bg-amber-500 rounded-full"></div>
                                                                <div>
                                                                    ...
                                                                    <p className="text-zinc-900 dark:text-white text-sm">{displayFatMass} kg</p>
                                                                </div>
                                                            </div>
                                                        </div>
