        ...
        {students.map(student => {
          ...
          return (
            <div
              ...
              className="bg-white dark:bg-zinc-900 rounded-[32px] border border-zinc-200 dark:border-zinc-800 p-6 hover:shadow-xl dark:hover:shadow-indigo-500/5 transition-all cursor-pointer group"
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  <img src={student.avatar} className="w-14 h-14 rounded-2xl object-cover" alt="" />
                  <div>
                    <h4 className="font-black text-zinc-800 dark:text-white text-lg group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{student.name}</h4>
                ...
                <div className="hidden md:flex w-10 h-10 bg-zinc-50 dark:bg-zinc-800 rounded-xl items-center justify-center text-zinc-300 dark:text-zinc-600 group-hover:bg-indigo-600 dark:group-hover:bg-indigo-500 group-hover:text-white dark:group-hover:text-white transition-all">
