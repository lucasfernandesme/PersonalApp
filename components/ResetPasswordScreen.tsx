            ...
            <div className="w-full max-w-md space-y-8 animate-in fade-in duration-500">
                <div className="text-center space-y-2">
                    <div className="mb-6 hover:scale-105 transition-transform duration-300">
                        <img src="/logo9.png" alt="PersonalFlow" className="w-24 h-24 object-contain mx-auto dark:hidden" />
                        <img src="/logo10.png" alt="PersonalFlow" className="w-24 h-24 object-contain mx-auto hidden dark:block" />
                    </div>
