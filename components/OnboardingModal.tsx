  ...
  return (
    <div className="fixed inset-0 z-[60] bg-zinc-50 dark:bg-zinc-950 flex flex-col md:inset-4 md:rounded-[40px] md:shadow-2xl md:max-w-md md:mx-auto md:overflow-hidden animate-in slide-in-from-bottom duration-300 transition-all overflow-hidden">
      ...
      <header className="bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 min-h-[5rem] flex items-end justify-between px-4 sticky top-0 z-40 transition-all duration-300 pt-14 pb-3 relative flex-shrink-0">
        <button onClick={step === 1 ? onClose : () => setStep(s => s - 1)} className="p-2 text-zinc-400 dark:text-zinc-500 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors z-10 w-10">
          <ChevronLeft size={20} />
        </button>
        ...
        <button onClick={onClose} className="p-2 text-zinc-300 dark:text-zinc-600 hover:text-red-500 transition-colors z-10 w-10 flex justify-end">
          <X size={20} />
        </button>
      </header>
