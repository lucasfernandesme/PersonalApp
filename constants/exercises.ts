...
export const EXERCISES_DB: LibraryExercise[] = [
  ...
  // COSTAS
  { name: 'Barra Fixa (Pegada Pronada)', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/poyr8KenUfc?rel=0&modestbranding=1' },
  { name: 'Barra Fixa (Pegada Supinada)', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/1EJ3A3rEtlo?rel=0&modestbranding=1' },
  { name: 'Barra Fixa (Pegada Neutra)', category: 'Costas' },
  { name: 'Puxada Frontal na Polia (Pegada Aberta)', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/iKrKgWR9wbY?rel=0&modestbranding=1' },
  { name: 'Puxada Frontal na Polia (Pegada Fechada)', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/uAyrz5GTEHg?rel=0&modestbranding=1' },
  { name: 'Puxada na Polia com Triângulo', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/7wEpfpKAiQ0?rel=0&modestbranding=1' },
  { name: 'Remada Curvada com Barra', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/paCfxhgW6bI?rel=0&modestbranding=1' },
  { name: 'Remada Curvada com Halteres', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/DhewkuU_95s?rel=0&modestbranding=1' },
  { name: 'Remada com Halteres (Unilateral)', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/YZgVEy6cmaY?rel=0&modestbranding=1' },
  ...
  { name: 'Remada Cavalinho', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/gJSov9rHIf0?rel=0&modestbranding=1' },
  { name: 'Pulldown no Aparelho', category: 'Costas' },
  { name: 'Pulldown com Corda', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/hlxb2zthgUw?rel=0&modestbranding=1' },
  { name: 'Face Pull na Polia', category: 'Costas' },
  { name: 'Superman (Isometria)', category: 'Costas', videoUrl: 'https://www.youtube.com/embed/D07urmRplHQ?rel=0&modestbranding=1' },
